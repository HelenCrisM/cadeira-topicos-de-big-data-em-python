...
quant_de_perguntas = 4
resposta_febre_alta = input('Febre alta? ')
resposta_dores_de_cabeca = input('Dores de cabeça? ')
resposta_dores_musculares = input('Dores musculares? ')
resposta_manchas_vermelhas_na_pele =  input('Manchas vermelhas na pele? ')
